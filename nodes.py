    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "filename_prefix": ("STRING", {"default": "ComfyUI_%date:yyyyMMdd%", "tooltip": "The prefix for the file to save. This may include formatting information such as %date:yyyy-MM-dd% or %Empty Latent Image.width% to include values from nodes."})
            },
            "hidden": {
